...
export default function RoomPage({ params }: { params: Promise<{ slug: string }> }) {
    ...
    return (
        <LanguageProvider lang={room.state.systemSettings?.defaultLanguage || 'tr'}>
            <>
                {/* ═══ GLASSMORPHISM TEMA — Demo chatroom CSS override'lar ═══ */}
                <style>{`
                    .room-glassmorphism .chat-area,
                    .room-glassmorphism [data-chat-messages] {
                        background: transparent !important;
                    }
                    .room-glassmorphism .chat-messages-container {
                        background: transparent !important;
                    }
                    .room-glassmorphism .chat-messages-container .animate-in {
                        animation: none !important;
                        opacity: 1 !important;
                        transform: none !important;
                    }
                    /* ── Bottom Toolbar — saydam, gölgesiz ── */
                    .room-glassmorphism .bottom-toolbar {
                        background: transparent !important;
                        border-top: none !important;
                        backdrop-filter: none !important;
                        box-shadow: none !important;
                    }
                    .room-glassmorphism .bottom-toolbar > div,
                    .room-glassmorphism .bottom-toolbar > div > div,
                    .room-glassmorphism .bottom-toolbar > div > div > div {
                        background: transparent !important;
                        box-shadow: none !important;
                        border-color: transparent !important;
                    }
                    /* İkon satırı kartı — ince çerçeve, saydam bg */
                    .room-glassmorphism .bottom-toolbar .bg-\\[\\#070B14\\]\\/80 {
                    ...
                    .room-glassmorphism .bottom-toolbar button:not(.send-button) {
                        background: rgba(255,255,255,0.04) !important;
                        border-color: rgba(255,255,255,0.06) !important;
                        box-shadow: none !important;
                    }
                    /* GÖNDER butonu */
                    .room-glassmorphism .bottom-toolbar .send-button {
                        box-shadow: 0 2px 8px rgba(0,0,0,0.2), inset 0 1px 0 rgba(255,255,255,0.06) !important;
                    }
                    /* Input alanı */
                    .room-glassmorphism .bottom-toolbar input,
                    .room-glassmorphism .bottom-toolbar textarea {
                    ...
                    .room-glassmorphism .message-bubble,
                    .room-glassmorphism .message-mine {
                        background: rgba(255,255,255,0.04) !important;
                        border-color: rgba(255,255,255,0.08) !important;
                    }
                    /* ── Glossy Panel efektleri ── */
                    .room-glossy-panel {
                        ...
                        border: 1px solid rgba(255,255,255,0.08) !important;
                        box-shadow: 0 8px 32px rgba(0,0,0,0.4), 0 2px 8px rgba(0,0,0,0.3), inset 0 1px 0 rgba(255,255,255,0.06) !important;
                    }
                    /* ── Sidebar glassmorphism ── */
                    .room-glassmorphism .sidebar-left-wrapper {
                        background: rgba(10, 14, 28, 0.65) !important;
                        backdrop-filter: blur(30px) !important;
                    }
                    /* ── Right Panel glassmorphism ── */
                    .room-glassmorphism .right-live-panel {
                        background: rgba(10, 14, 28, 0.65) !important;
                        backdrop-filter: blur(30px) !important;
                    }
                `}</style>
                {/* Nudge shake class applied via globals.css */}
                <main className={`app-background h-screen w-full flex items-center justify-center p-4 overflow-hidden text-slate-200 selection:bg-indigo-500/30 room-glassmorphism ${nudgeActive ? 'nudge-shake' : ''}`} style={{ perspective: '1200px', background: 'radial-gradient(ellipse 80% 60% at 50% 40%, rgba(20, 28, 58, 0.95) 0%, rgba(10, 14, 30, 0.98) 50%, #080c18 100%)' }}>
                    ...
                    {isOne2OneRoom ? (
                        ...
                        `}</style>
                            ...
                            <div className={`glass-panel room-container room-glossy-panel w-full max-w-[1700px] h-[88vh] rounded-[28px] flex overflow-hidden relative shadow-2xl`}
                                style={{
                                    ...
                                    ...(isMeetingRoom ? {
                                        ...
                                        border: '1px solid rgba(147, 130, 220, 0.12)',
                                        boxShadow: '0 0 60px rgba(147, 130, 220, 0.12), 0 0 120px rgba(123, 159, 239, 0.06), 0 40px 80px rgba(0,0,0,0.5), inset 0 1px 0 rgba(255,255,255,0.06)',
                                        ...(activeDesign?.colors ? {
                            ...
                            >
                                {/* ═══ UNIFIED TOP BAR OVERLAY — lavanta/mavi glassmorphism ═══ */}
                                <div className="absolute top-0 left-0 right-0 h-[96px] z-20 pointer-events-none rounded-t-[28px]" style={{ background: 'linear-gradient(180deg, rgba(147, 130, 220, 0.08) 0%, rgba(123, 159, 239, 0.04) 40%, transparent 100%)' }}>
                                    {/* Top edge highlight — lavanta */}
                                    <div className="absolute top-0 left-0 right-0 h-[1px] rounded-t-[28px]" style={{ background: 'linear-gradient(90deg, transparent 5%, rgba(147,130,220,0.25) 25%, rgba(123,159,239,0.35) 50%, rgba(147,130,220,0.25) 75%, transparent 95%)' }} />
                                    {/* Bottom accent glow line — lavanta */}
                                    <div className="absolute bottom-0 left-0 right-0 h-[1px]" style={{ background: 'linear-gradient(90deg, transparent 5%, rgba(147,130,220,0.15) 25%, rgba(123,159,239,0.25) 50%, rgba(147,130,220,0.15) 75%, transparent 95%)', boxShadow: '0 1px 10px rgba(123,159,239,0.06)' }} />
                                </div>
                                {/* Lavanta geçişli blur glow efektleri */}
                                <div style={{ position: 'absolute', top: -20, right: -20, width: 200, height: 200, background: 'radial-gradient(circle, rgba(147, 130, 220, 0.12) 0%, rgba(123, 159, 239, 0.06) 50%, transparent 70%)', filter: 'blur(40px)', pointerEvents: 'none', zIndex: 0 }} />
                                <div style={{ position: 'absolute', bottom: -20, left: -20, width: 160, height: 160, background: 'radial-gradient(circle, rgba(123, 159, 239, 0.08) 0%, transparent 70%)', filter: 'blur(40px)', pointerEvents: 'none', zIndex: 0 }} />
                                ...
                                <main className="flex-1 flex flex-col min-w-0 relative z-10" onContextMenu={handleChatContextMenu} style={{ background: 'transparent' }}>
                                    {isMeetingRoom ? (
