                                        ...
                                        <div style={{ display: 'flex', gap: 8 }}>
                                            <button
                                                ...
                                                style={{
                                                    ...
                                                    fontSize: 10, fontWeight: 700, color: '#e2e8f0', transition: 'all 0.2s', fontFamily: 'inherit',
                                                }}
                                            ...
                                            <button
                                                ...
                                                style={{
                                                    ...
                                                    display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6,
                                                    fontSize: 10, fontWeight: 700, color: '#93c5fd', transition: 'all 0.2s', fontFamily: 'inherit',
                                                }}
