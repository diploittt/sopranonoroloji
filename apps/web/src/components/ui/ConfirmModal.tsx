...
export default function ConfirmModal({
    ...
    return (
        <div className="fixed inset-0 z-[200] flex items-center justify-center">
            ...
            <div className="relative w-full max-w-sm bg-[#0f111a] border border-white/10 shadow-2xl rounded-2xl p-6 animate-in zoom-in-95 fade-in duration-200 cursor-grab active:cursor-grabbing" style={{ transform: `translate(${offset.x}px, ${offset.y}px)` }} onMouseDown={onDragMouseDown}>
