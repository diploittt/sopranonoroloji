            ...
            <div className="relative w-full max-w-5xl max-h-[85vh] flex flex-col animate-in zoom-in-95 fade-in duration-300" style={{
                ...
                <div className="px-4 py-2.5 bg-[#1e293b] flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        ...
                        <h2 className="text-xs font-bold text-white">Sipariş Yönetimi</h2>
                        {pendingCount > 0 && (
                            <span className="px-2 py-0.5 bg-yellow-500/20 text-yellow-300 text-[10px] font-bold rounded-full border border-yellow-500/30 ml-1">
                                {pendingCount} Beklemede
                            </span>
                        )}
                    </div>
                    <div className="flex items-center gap-1">
                        <button onClick={fetchOrders} className="p-1.5 hover:bg-white/10 rounded-md text-gray-400 hover:text-white transition-all" title="Yenile">
                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar" style={{ padding: '12px 16px 16px' }}>
                    {loading ? (
                        ...
                        <div className="grid gap-4">
                            {orders.map((order) => (
                                <div key={order.id} className="bg-[#f8fafc] border border-[#e2e8f0] rounded-lg p-4 hover:border-blue-300 transition-all group">
