                    ...
                    <div className="flex items-center justify-between cursor-grab active:cursor-grabbing select-none" onMouseDown={onDragMouseDown}>
                        <div className="flex items-center gap-3">
                            <div style={{
                                ...
                                <Shield className="w-5 h-5 text-rose-400" style={{ filter: 'drop-shadow(0 0 6px rgba(225,29,72,0.5))' }} />
                            </div>
                            <div>
                                <h2 className="text-lg font-bold text-white" style={{ letterSpacing: '-0.01em' }}>Müşteri Düzenle</h2>
                                <p className="text-[11px] text-gray-500">Müşteri bilgileri ve oda ayarları</p>
                            </div>
                        </div>
